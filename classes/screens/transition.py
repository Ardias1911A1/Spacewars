...
class Transition:
    def __init__(self, imagePath:str, text:str=None):
    ...
    def displayTransition(self, window:pygame.display, text:str=""):
        ...
        title = pygame.font.Font(self._font,22).render(text,16,(0,200,0))
